...
# Basics
API_ID = config("12665045", default=None, cast=int)
API_HASH = config("d437379dcebbc0a422211503956d8194", default=None)
BOT_TOKEN = config("6009441071:AAHoB7Jf3CRLTcJlsEcUyVzPKm7I-YwLu7I", default=None)
